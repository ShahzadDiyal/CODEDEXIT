...
const artificial_intelligence_service = () => {
  useEffect(() => {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h3 className="clr-light mb-3"> Artificial Intelligence Service</h3>
        ...
        <div className="container">
          <div className="row g-4">
            ...
            <div className="col-md-6">
              <p>
                {" "}
                We are an AI solutions company, delivering intelligent and innovative digital transformation services. Let us help you enhance efficiency with cutting-edge technologies like machine learning, natural language processing, predictive analytics, automation, and AI-driven decision-making.{" "}
              </p>
            </div>
            <div className="col-md-6">
              <p className="mb-8">
                {" "}
                We have extensive expertise in delivering advanced AI solutions. By harnessing cutting-edge artificial intelligence technologies and the right tools, our team develops intelligent, scalable, and efficient solutions tailored to business needs. Implementing AI is a complex process, and we support you at every stage, from data strategy and model development to deployment, optimization, and ongoing maintenance.{" "}
              </p>
              <Link
                href="contact-us"
      ...
      <div className="ai-service-section">
        <div className="ai-service-section__content bg-base-800">
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-xl-5 z-1">
                ...
                <p className="clr-light mb-8 xxl-text">
                  ...
                  Are you a startup or an established company in the UK or worldwide? It doesn't matter.
                   We provide AI-driven solutions tailored to businesses of all sizes and industries.{" "}
                </p>
                <p className="clr-light mb-5">
                  {" "}
                  Our intelligent solutions automate tasks, analyze data, and enhance decision-making, helping you stay competitive,
                   improve efficiency, and drive growth with cutting-edge technology.{" "}
                </p>
                <p className="clr-light mb-5">
                  {" "}
                  From machine learning to predictive analytics, our AI solutions streamline operations, boost productivity, and create
                   personalized customer experiences, revolutionizing the way you do business.{" "}
                </p>
                <p className="clr-light mb-12">
                  {" "}
                  Leverage real-time data, optimize workflows, and automate complex processes effortlessly. Our scalable AI 
                  solutions adapt to your needs, ensuring sustainable growth and innovation.{" "}
                </p>
                <Link
                  href="contact-us"
                  className="bttn gap-2 bttn--base bttn-md bttn-pill fw-md flex-shrink-0">
            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-xl-9">
                <span className="d-block h5 lh-1 fw-semibold clr-base text-center">
                  {" "}
                  Professional Artificial Intelligence Services{" "}
                </span>
                <h2 className="mt-5 mb-5 text-center">
                  {" "}
                  AI-powered experts craft innovative, user-friendly 
                  websites tailored to your brand’s vision.{" "}
                </h2>
                <p className="text-center mx-auto max-text-70">
                  {" "}
                  With deep expertise in AI, we develop intelligent, scalable solutions tailored to your needs. From concept to deployment and continuous improvement, 
                  we ensure seamless integration, automation, and innovation for a perfect market fit.{" "}
                </p>
              </div>
            </div>
          </div>
...
export default artificial_intelligence_service;
