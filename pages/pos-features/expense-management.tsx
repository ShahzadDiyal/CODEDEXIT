...
const Expense_Management_Module = () => {
  useEffect(() => {
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h3 className="clr-light mb-3">Expense Management</h3>
        ...
        <div className="container">
          ...
          <div className="row g-4">
            ...
            <div className="col-md-6 align-self-center">
              <h4><u>Expense List</u></h4>
              <p>
                {" "}
                The Expense List tab provides a structured table for tracking business expenses efficiently. With Store Name, Expense Reference, Date, Type, Amount, and Creation Date, users gain clear financial insights. Pagination, date filters, and search functionality enable quick access to records. The Action column allows seamless expense management,
                 ensuring accurate tracking, better budgeting, and improved financial transparency.{" "}
              </p>
          ...
          <div className="row g-4">
            ...
            <div className="col-md-6 align-self-center">
              <img
                src="/images/expense-type-list.png"
                alt="image"
                className="img-fluid flex-shrink-0"
                style={{border:"1px solid", borderRadius:"5px"}}
              />
            ...
            <div className="col-md-6 align-self-center">
              <h4><u>Expense Type List</u></h4>
              <p>
                {" "}
                The Expense Type List tab organizes expenses by category, ensuring clear financial tracking. With a structured table displaying Store Name, Expense Name, and Creation Date, users can efficiently manage and analyze expenses. Search, date filters, and pagination enhance accessibility, while the Action column allows seamless editing,
                 ensuring accurate records, better budgeting, and improved financial transparency.{" "}
              </p>
            </div>
          </div>
        </div>
...
export default Expense_Management_Module;
