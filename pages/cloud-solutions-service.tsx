...
const cloud_solutions_service = () => {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h3 className="clr-light mb-3"> Cloud Solutions</h3>
        ...
        <div className="container">
          <div className="row g-4">
            ...
            <div className="col-md-6">
              <p>
                {" "}
                We are a Cloud Solutions company, providing scalable and secure digital transformation services. Let us help you optimize operations with cutting-edge technologies like cloud computing, data storage, cybersecurity, real-time collaboration, and AI-powered automation.{" "}
              </p>
            </div>
            <div className="col-md-6">
              <p className="mb-8">
                {" "}
                We have extensive expertise in delivering advanced Cloud Solutions. By leveraging the latest cloud technologies and the right tools, our team develops scalable, secure, and efficient solutions tailored to business needs. Managing cloud infrastructure is a complex process, and we support you at every stage,
                 from planning and deployment to optimization and ongoing maintenance.{" "}
              </p>
              <Link
                href="contact-us"
      ...
      <div className="cloud-service-section">
        <div className="cloud-service-section__content bg-base-800">
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-xl-5 z-1">
                ...
                <p className="clr-light mb-8 xxl-text">
                  {" "}
                  Are you a startup, a well-established company, or a global enterprise? No matter your size or location, our cloud solutions 
                  empower businesses with scalability, security, and seamless digital transformation.{" "}
                </p>
                <p className="clr-light mb-5">
                  {" "}
                  Our cutting-edge cloud solutions enhance scalability, improve data security, and streamline workflows, helping 
                  businesses achieve agility, efficiency, and cost savings in an ever-evolving digital landscape.{" "}
                </p>
                <p className="clr-light mb-5">
                  {" "}
                  We provide customized cloud solutions tailored to your needs, ensuring smooth migration, real-time collaboration,
                   and optimized performance to drive innovation and business growth without disruption.{" "}
                </p>
                <p className="clr-light mb-12">
                  {" "}
                  Leverage advanced cloud technology for enhanced storage, automation, and accessibility. Our expert team ensures high availability, 
                  data protection, and reliable performance, empowering you to stay ahead of the competition.{" "}
                </p>
                <Link
                  href="contact-us"
                  className="bttn gap-2 bttn--base bttn-md bttn-pill fw-md flex-shrink-0">
            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-xl-9">
                ...
                <h2 className="mt-5 mb-5 text-center">
                  {" "}
                  A team of cloud experts helping you build secure, scalable, and efficient solutions.{" "}
                </h2>
                <p className="text-center mx-auto max-text-70">
                  {" "}
                  With expertise in cloud solutions, we deliver scalable, secure, 
                  and efficient systems, guiding you from planning to deployment and ongoing maintenance.{" "}
                </p>
              </div>
            </div>
          </div>
...
export default cloud_solutions_service;
