...
const custom_solutions_service = () => {
  useEffect(() => {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h3 className="clr-light mb-3"> Custom Solutions Service</h3>
        ...
        <div className="container">
          <div className="row g-4">
            <div className="col-md-7 col-xl-5">
              <h2> Custom Solutions Service</h2>
            </div>
            <span className="w-100"></span>
            <div className="col-md-6">
              <p>
                {" "}
                We are a Custom Solutions company, delivering tailored and innovative digital transformation services. Let us help you optimize operations with cutting-edge technologies, personalized software development, automation, and scalable solutions designed to meet your unique business needs for seamless growth and efficiency.{" "}
              </p>
            </div>
            <div className="col-md-6">
              <p className="mb-8">
                {" "}
                We specialize in delivering custom AI and Chatbot solutions tailored to your unique business needs. Our team leverages cutting-edge technologies to develop intelligent, scalable, and efficient chatbot systems that enhance user experiences and streamline operations. From initial strategy and custom conversational design to model development, deployment, and continuous optimization, we ensure a seamless integration of AI into your business. Whether you need a chatbot for customer support, sales, or internal automation, our experts craft solutions that drive engagement
                 and efficiency while providing ongoing support and maintenance.{" "}
              </p>
              <Link
                href="contact-us"
      ...
      <div className="custom-solutions-service-section">
        <div className="custom-solutions-service-section__content bg-base-800">
          <div className="container">
            <div className="row">
            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-xl-9">
                ...
                <h2 className="mt-5 mb-5 text-center">
                  {" "}
                  A team of custom solutions experts that can help you design and build a solution you’re proud of.{" "}
                </h2>
                <p className="text-center mx-auto max-text-70">
                  {" "}
                  We have extensive experience in creating cutting-edge solutions. Using the best technologies, we develop market-fit products and
                   support you through every step, from ideation to development and ongoing maintenance.{" "}
                </p>
              </div>
            </div>
          </div>
...
export default custom_solutions_service;
