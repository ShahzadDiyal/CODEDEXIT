        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h3 className="clr-light mb-3"> IT Solutions</h3>
        ...
        <div className="container">
          <div className="row g-4">
            ...
            <div className="col-md-6">
              <p>
                {" "}
                We are an IT solutions company, providing cutting-edge technology services. Let us help you build exceptional solutions with
                frameworks like Symfony, Laravel, React, Vue.js, and Node.js.{" "}
              </p>
            </div>
            <div className="col-md-6">
              <p className="mb-8">
                {" "}
                We have extensive experience in delivering cutting-edge IT solutions. By leveraging the latest technologies and the right tools, our team develops tailored solutions that perfectly align with market needs. Building an IT solution is a complex process, and we support you at every stage, from conceptualizing
                your vision to development, implementation, and ongoing maintenance.{" "}
              </p>
              <Link
                href="contact-us"
            ...
            <div className="row">
              <div className="col-lg-6 col-xl-5 z-1">
                ...
                <p className="clr-light mb-8 xxl-text">
                  {" "}
                  Are you a growing startup, a well-established enterprise, in the UK or worldwide? It doesn’t matter.
                  We provide IT solutions for businesses of all sizes.{" "}
                </p>
                <p className="clr-light mb-5">
                  {" "}
                  Our company delivers cutting-edge IT solutions, empowering businesses
                  with seamless technology integration, automation, and security. We provide tailored solutions to enhance efficiency, scalability, and digital transformation.{" "}
                </p>
                <p className="clr-light mb-5">
                  {" "}
                  With a team of experts, we develop innovative IT strategies,
                  ensuring businesses stay ahead in a competitive market. From cloud solutions to cybersecurity, we optimize operations effectively.{" "}
                </p>
                <p className="clr-light mb-12">
                  {" "}
                  We prioritize long-term partnerships, offering continuous support and maintenance. Our goal is to help businesses achieve success through reliable, future-proof
                  IT solutions that drive growth, productivity, and innovation.{" "}
                </p>
                <Link
                  href="contact-us"
                  className="bttn gap-2 bttn--base bttn-md bttn-pill fw-md flex-shrink-0">
            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-xl-9">
                ...
                <h2 className="mt-5 mb-5 text-center">
                  {" "}
                  Expert IT team delivering innovation, security, efficiency, scalability, and business growth. {" "}
                </h2>
                <p className="text-center mx-auto max-text-70">
                  {" "}
                  We deliver innovative, scalable, and secure IT solutions, optimizing operations, enhancing security, and driving growth. From development to deployment and maintenance,
                   we ensure seamless execution for long-term success and digital transformation.{" "}
                </p>
              </div>
            </div>
          </div>
...
export default it_solutions_service;
