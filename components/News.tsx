  ...
  return (
    <div className="section">
      <div className="container mt-5">
        <span className="d-block h5 lh-1 fw-semibold clr-base text-center mb-2 mt-1" style={{ fontSize:"30px"}}>
          {" "}
          Latest News{" "}
        </span>
        <p className="text-center mx-auto t-short-para mb-2" style={{padding: "20px"}}>
          {" "}
